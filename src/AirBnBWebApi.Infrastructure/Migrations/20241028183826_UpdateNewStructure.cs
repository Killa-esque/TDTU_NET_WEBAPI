...
{
    public partial class UpdateNewStructure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefreshTokensUsed", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RefreshTokensUsed_KeyTokens_UserId",
                        column: x => x.UserId,
                        principalTable: "KeyTokens",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RefreshTokensUsed_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokensUsed_UserId",
                table: "RefreshTokensUsed",
                column: "UserId");
